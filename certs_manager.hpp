...
static constexpr auto DEFAULT_KEYBITLENGTH = 2048;
static constexpr auto DEFAULT_KEYCURVEID = "secp224r1";
...
class Manager : public Ifaces
{
  ...
  private:
     ...
     */
    EVP_PKEY_Ptr generateECKeyPair(std::string& p_KeyCurveId);
