...
class Manager : public Ifaces
{
  public:
     ...
     *      algorithms. Valid built-in algorithm names for private ke 
     ...
     *      representing CSR string. Note: For new CSR request will overwrite the
  ...
  private:
    ...
    std::unique_ptr<CSRRead> csrPtr = nullptr;
