...
namespace internal
{
using CertificateInterface = sdbusplus::server::object::object<
...
class Certificate : public internal::CertificateInterface
{
  public:
    ...
    Certificate(sdbusplus::bus::bus& bus, const std::string& objPath,
                ...
                std::optional<std::reference_wrapper<Watch>> watch,
                Manager& parent);
  ...
  private:
    ...
    std::optional<std::reference_wrapper<Watch>> certWatch;
