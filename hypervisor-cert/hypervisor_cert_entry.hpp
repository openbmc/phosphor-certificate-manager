...
#include "com/ibm/HypervisorCertificate/Entry/server.hpp"
...
using CSREntry = sdbusplus::com::ibm::HypervisorCertificate::server::Entry;
...
/** @class Entry
 *  @brief Hypervisor certificate Entry implementation.
 *  @details A concrete implementation for the
 *           com.ibm.HypervisorCertificate.Entry DBus API
 */
class Entry : public CSRIface
{
  public:
    ...
    Entry(sdbusplus::bus::bus& bus, const std::string& objPath,
          ...
          sdbusplus::message::unix_fd certFd, HypCertMgr& manager) :
