...
void Manager::serverInstall(const std::string& filePath)
{
...
void Manager::clientInstall(const std::string& filePath)
{
    if (!compareKeys(filePath))
    {
        elog<InvalidCertificate>(
...
void Manager::authorityInstall(const std::string& filePath)
{
